...
function ProfileContainer() {
	return (
		<Box sx={{bgcolor: theme.palette.primary.main}}>
				<Avatar alt="yoyoyo" src="https://pbs.twimg.com/profile_images/1633238286045962243/JfgDezi9_400x400.jpg" sx={{mt: 10, width: 200, height: 200, boxShadow: 10, margin: '0 auto'}}></Avatar>
